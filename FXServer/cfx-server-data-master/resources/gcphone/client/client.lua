...
function ShowNoPhoneWarning () 
  ...
  ESX.ShowNotification("Não tens um ~r~telemóvel~s~")
end
...
AddEventHandler("gcPhone:acceptCall", function(infoCall, initiator)
  if inCall == false and USE_RTC == false then
    ...
    -- NetworkSetTalkerProximity(0.0)
	  --exports.tokovoip_script:addPlayerToRadio(infoCall.id + 720)
    --TokoVoipID = infoCall.id + 720

    exports["mumble-voip"]:SetCallChannel(infoCall.id + 800)
  end
  if menuIsOpen == false then 
    TooglePhone()
  end
