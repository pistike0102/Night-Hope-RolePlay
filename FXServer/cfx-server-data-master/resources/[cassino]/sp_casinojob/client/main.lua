...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    if PlayerData.job.grade_name =='boss' then    
        table.insert(elements, {label =('Tenue Patron'), value = 'boss_outfit_4'})
    end
      ...
      --menu.close()
        ...
        elseif data.current.value == 'barman_outfit' then
            TriggerEvent('skinchanger:getSkin', function(skin)
             TriggerServerEvent("player:serviceOn", "casino")
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          ESX.Game.SpawnVehicle(vehicleProps.model, vehicles.SpawnPoint, vehicles.Heading, function(vehicle)
              ...
              local playerPed = GetPlayerPed(-1)
			  local plate = 'Casino' .. math.random(100, 900)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(player), 'society_casino', _U('billing'), amount)
        end
