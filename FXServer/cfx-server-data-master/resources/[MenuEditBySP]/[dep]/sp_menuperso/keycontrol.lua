...
RegisterNetEvent('SP:closeAllSubMenu')
AddEventHandler('SP:closeAllSubMenu', function()
	TriggerEvent('SP:closeMenuAmbulance')
	TriggerEvent('SP:closeMenuPolice')
	TriggerEvent('SP:closeMenuMecano')
	TriggerEvent('SP:closeMenuInventaire')
	TriggerEvent('SP:closeMenuPersonnel')
end)

RegisterNetEvent('SP:closeAllMenu')
AddEventHandler('SP:closeAllMenu', function()
...
--------------------------------------------------------------------------------------------
-- Menu Perso
RegisterNetEvent('SP:closeMenuPersonnel')
AddEventHandler('SP:closeMenuPersonnel', function()
...
-- Inventaire
RegisterNetEvent('SP:closeMenuInventaire')
AddEventHandler('SP:closeMenuInventaire', function()
