...
ESX.RegisterServerCallback('SP:getUsergroup', function(source, cb)
...
-------------------------------------------------------------------------------Grade Menu
RegisterServerEvent('SP:promouvoirplayer')
AddEventHandler('SP:promouvoirplayer', function(target)
...
RegisterServerEvent('SP:destituerplayer')
AddEventHandler('SP:destituerplayer', function(target)
...
RegisterServerEvent('SP:recruterplayer')
AddEventHandler('SP:recruterplayer', function(target, job, grade)
...
RegisterServerEvent('SP:virerplayer')
AddEventHandler('SP:virerplayer', function(target)
